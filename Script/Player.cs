...
public class Player : MonoBehaviour
{
    ...
    [Header("UI Elements")]
    [SerializeField] private Image dashIcon; // Icon hiển thị trạng thái Dash
    ...
    {
        dashIcon.color = isReady ? new Color(1f, 1f, 1f, 1f) : new Color(1f, 1f, 1f, 0.5f); // Sáng nếu sẵn sàng, tối nếu đang cooldown
    }
}